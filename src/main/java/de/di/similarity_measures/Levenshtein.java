...
public class Levenshtein implements SimilarityMeasure {
    ...
    public double calculate(final String string1, final String string2) {
        ...
        // Calculate Levenshtein similarity (1 - normalized Levenshtein distance)
        double levenshteinDistance = upperLine[string1.length()];
        double maxPossibleDistance = Math.max(string1.length(), string2.length());
        levenshteinSimilarity = 1.0 - (levenshteinDistance / maxPossibleDistance);
        //                                                                                                            //
        ////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public double calculate(final String[] strings1, final String[] strings2) {
        ...
        // Calculate Levenshtein similarity (1 - normalized Levenshtein distance)
        double levenshteinDistance = upperLine[strings1.length];
        double maxPossibleDistance = Math.max(strings1.length, strings2.length);
        levenshteinSimilarity = 1.0 - (levenshteinDistance / maxPossibleDistance);
